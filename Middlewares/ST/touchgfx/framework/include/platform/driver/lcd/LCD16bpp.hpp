...
protected:
    ...
    /**
     * Blits a L4 compressed 2D indexed 8-bit source to the framebuffer performing software
     * alpha-blending per pixel.
     *
     * @param  sourceData The source-indexes pointer (points to the beginning of the compressed data).
     *                    The sourceData must be stored as L4 compressed 8- bits indexes.
     * @param  clutData   The source-clut pointer points to the beginning of the CLUT color
     *                    format and size data followed by colors entries stored as 16-
     *                    bits (ARGB8888) format. If the source have per pixel alpha
     ...
     *                    solid, no blending)
     */
    static void blitCopyL8_ARGB8888_L4Compressed(const uint8_t* sourceData, const uint8_t* clutData, const Rect& source, const Rect& blitRect, uint8_t alpha);

    /**
     * Blits a RLE compressed 2D indexed 8-bit source to the framebuffer performing software
     * alpha-blending per pixel.
     *
     * @param  sourceData The source-indexes pointer (points to the beginning of the compressed data).
     *                    The sourceData must be stored as RLE compressed 8- bits indexes.
     * @param  clutData   The source-clut pointer points to the beginning of the CLUT color
     *                    format and size data followed by colors entries stored as 16-
     *                    bits (ARGB8888) format. If the source have per pixel alpha
     *                    channel, then alpha channel data will be following the clut
     ...
     *                    solid, no blending)
     */
    static void blitCopyL8_ARGB8888_RLECompressed(const uint8_t* sourceData, const uint8_t* clutData, const Rect& source, const Rect& blitRect, uint8_t alpha);

    /**
     * Blits a LZW9 compressed 2D indexed 8-bit source to the framebuffer performing software
     * alpha-blending per pixel.
     *
     * @param  sourceData The source-indexes pointer (points to the beginning of the compressed data).
     *                    The sourceData must be stored as LZW9 compressed 8- bits indexes.
     * @param  clutData   The source-clut pointer points to the beginning of the CLUT color
     *                    format and size data followed by colors entries stored as 16-
     *                    bits (ARGB8888) format. If the source have per pixel alpha
     *                    channel, then alpha channel data will be following the clut
     ...
     *                    solid, no blending)
     */
    static void blitCopyL8_ARGB8888_LZW9Compressed(const uint8_t* sourceData, const uint8_t* clutData, const Rect& source, const Rect& blitRect, uint8_t alpha);
     ...
     *                    solid, no blending)
     */
    static void blitCopyL8_RGB565_L4Compressed(const uint8_t* sourceData, const uint8_t* clutData, const Rect& source, const Rect& blitRect, uint8_t alpha);
     ...
     *
     * @param  sourceData The source-indexes pointer (points to the beginning of the data). The
     *                    sourceData must be stored as RLE compressed 8 bits codes.
     * @param  clutData   The source-clut pointer points to the beginning of the CLUT color
     *                    format and size data followed by colors entries stored as 16-
     *                    bits (RGB565) format. If the source have per pixel alpha
     *                    channel, then alpha channel data will be following the clut
     ...
     *                    solid, no blending)
     */
    static void blitCopyL8_RGB565_RLECompressed(const uint8_t* sourceData, const uint8_t* clutData, const Rect& source, const Rect& blitRect, uint8_t alpha);
     ...
     *                    solid, no blending)
     */
    static void blitCopyL8_RGB565_LZW9Compressed(const uint8_t* sourceData, const uint8_t* clutData, const Rect& source, const Rect& blitRect, uint8_t alpha);
...
private:
    ...
    static uint16_t blendPixelRGB565(uint16_t imagePixel, uint16_t fbPixel, int alpha, int ialpha);
    static uint16_t blendPixelARGB8888(uint32_t imagePixel, uint16_t fbPixel, int alpha, uint8_t alphapix);
