...
UPGRADE
  ...
  if __FILE__ == $0
    ...
    if File.file?(application_config)
      ...
      fusion_font = text_conf["korean_fusion_font"]
      if fusion_font
        korean_fusion_font = fusion_font
      end
    end
    ...
    begin
      ...
      Generator.new.run(file_name, @fonts_output_path, @localization_output_path, font_asset_path, data_format, remap_global, autohint_setting, generate_binary_translations, generate_binary_fonts, framebuffer_bpp, generate_font_format, korean_fusion_font)
